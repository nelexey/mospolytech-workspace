...
from bot.keyboards.inline.menu import get_back_to_menu_keyboard, get_topics_keyboard
...
async def show_topics(message, edit=False):
    """Показывает доступные темы консультаций по кибербезопасности"""
    
    topics_text = (
        "<b>📚 Доступные темы консультаций по кибербезопасности:</b>\n\n"
        "🔹 <b>Защита от вредоносного ПО</b>\n"
        "   Идентификация и предотвращение атак вредоносного ПО\n\n"
        "🔹 <b>Анализ уязвимостей</b>\n"
        "   Методы поиска и устранения уязвимостей в системах\n\n"
        "🔹 <b>Сетевая безопасность</b>\n"
        "   Защита корпоративных и домашних сетей\n\n"
        "🔹 <b>Криптография и шифрование</b>\n"
        "   Основы криптографии и безопасного хранения данных\n\n"
        "🔹 <b>Безопасность веб-приложений</b>\n"
        "   Защита от OWASP Top 10 и других веб-угроз\n\n"
        "🔹 <b>Социальная инженерия</b>\n"
        "   Распознавание и противодействие социальной инженерии\n\n"
        "🔹 <b>Incident Response</b>\n"
        "   Реагирование на инциденты кибербезопасности\n\n"
        "🔹 <b>Подготовка к CTF-соревнованиям</b>\n"
        "   Тренировка для участия в CTF на Киберполигоне\n\n"
    )
    
    if edit:
        await message.edit_text(topics_text, reply_markup=get_topics_keyboard(), parse_mode="HTML")
    else:
        await message.answer(topics_text, reply_markup=get_topics_keyboard(), parse_mode="HTML") 